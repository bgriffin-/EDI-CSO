...
part / --fstype ext4 --size 40000 --grow --maxsize 1
part swap --recommended
#System authorization infomation
auth  --useshadow  --enablemd5
#Network information
network --hostname=jedi --bootproto=static --ip=192.168.10.5 --netmask=255.255.255.0 --gateway=192.168.10.1 --nameserver=192.168.10.10 --device=eth0 --noipv6
